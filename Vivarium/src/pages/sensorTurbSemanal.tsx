    ...
    const fetchData = async () => {
      ...
      for (let i = 6; i >= 0; i--) {
        ...
        try {
          ...
          if (snapshot.exists()) {
            const valor = snapshot.val().mediaTurbidez || 0;
    ...
    <div className="stud-container">
      <aside>
        ...
        <nav className="stud-options">
          <ul>
            <li className="stud-active" onClick={() => router.push("/home")}>
          ...
          <div className="stud-card">
            <div className="stud-h1-title">
              ...
              <div className="stud-side-buttons">
                <button id='BUTTON' className="stud-side-btn">Semanal</button>
                <button className="stud-side-btn" onClick={() => router.push("/sensorTurbDiario")}>Diário</button>
              </div>
            </div>
