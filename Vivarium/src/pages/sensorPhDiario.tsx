...
export default function SensorPhDiario() {
      ...
      for (let hour = 0; hour < 24; hour++) {
        ...
        try {
          ...
          if (snapshot.exists()) {
            ...
            const ph = data.mediaPH || 0;
            newChartData.push({ name: hourLabel, leitura: ph });
          } else {
          ...
          <div className="spd-card">
            <div className="spd-h1-title">
              ...
              <div className="spd-side-buttons">
                <button className="spd-side-btn" onClick={() => router.push('/sensorPhSemanal')}>Semanal</button>
                <button id='BUTTON' className="spd-side-btn">Diário</button>
              </div>
            </div>
